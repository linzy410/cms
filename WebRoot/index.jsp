	...
	<body>
		...
		<div class="mainmenu" id="mo_menu">
			<ul>
				...
				<li class="menuDiv"></li>
				<li class="">
					<a href="/product/">展会概况</a>
				</li>
				<li class="menuDiv"></li>
				<li class="">
					<a href="/about-us/list-231736.html" title="成功案例">展商类别</a>
				</li>
				<li class="menuDiv"></li>
				<li class="">
					<a href="/about-us/list-227160.html" title="公司图片">观众来源</a>
				</li>
				<li class="menuDiv"></li>
				<li class="">
					<a href="/contact/">新闻资讯</a>
				</li>
				<li class="menuDiv"></li>
				<li class="">
					<a href="/inquiry.html" rel="nofollow">合作伙伴</a>
				</li>
			</ul>
		</div>
		<div class="main">
